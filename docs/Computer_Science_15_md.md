...
|عنوان درس به فارسی:|<h3>یادگیری آماری مقدماتی</h3>|
| -: | :- |
|عنوان درس به انگلیسی:|Elementary Statistical Learning|نوع درس و واحد|
|دروس پیش‏نیاز:|رگرسیون1 |پایه £|نظری**n**|
|دروس هم‏نیاز:||تخصصی الزامی**n**|عملی £|
|تعداد واحد:|1+2||تخصصی اختیاری  £|نظری-عملی **£**|
|تعداد ساعت:|32+32||رساله / پایان‏نامه £|نظری-محاسباتی £|
|نوع آموزش تکمیلی عملی (در صورت نیاز): سفر علمی £ آزمایشگاه نرم افزار ¢ سمینار £ کارگاه £ موارد دیگر: ..............|
||
هدف کلی: آشنایی با جایگاه مدل‌های آماری در یادگیری ماشینی با نظارت و بی نظارت 

اهداف ویژه: توانمندی و مهارت در  مطالعه ساختار داده‌ها و یافتن  یک تابع پیش‌بینی بر اساس داده‌ها
...
|نوع آموزش تکمیلی عملی (در صورت نیاز): سفر علمی £ آزمایشگاه نرم افزار £  سمینار £ کارگاه ¢موارد دیگر: ..............|
||
هدف کلی:  **بررسی و تحلیل داده های با حجم بالا و معرفی روش های متفاوت برای کلاستر کردن آن ها**

اهداف ویژه: دانشجو با روشهای داده کاوی آشنا و با مفاهیم آن کار می کند.
...
|عنوان درس به فارسی:|<h3><a name="_یادگیری_آماری_"></a>یادگیری ماشین  مقدماتی ۱</h3>|
| -: | :- |
|عنوان درس به انگلیسی:|Elementary Machine Learning I|نوع درس و واحد|
|دروس پیش‏نیاز:|رگرسیون ۱|پایه £|نظری ¢|
|دروس هم‏نیاز:||تخصصی الزامی£|عملی £|
|تعداد واحد:|3|حل تمرین دارد|تخصصی اختیاری ¢|نظری-عملی £|
|تعداد ساعت:|48||رساله / پایان‏نامه £||
|نوع آموزش تکمیلی عملی (در صورت نیاز): سفر علمی £ آزمایشگاه ¢ سمینار £ کارگاه £ موارد دیگر: ..............|
هدف کلی: آشنایی با یادگیری آماری

اهداف ویژه: یادگیری بانظارت، رگرسیون خطی، لاجیستیک رگرسیون، روش‌های منظم‌ساز، رگرسیون ریج و روشهای ارزیابی طبقه‌بندها
...
|عنوان درس به فارسی:|<h3><a name="_یادگیری_آماری__1"></a>یادگیری ماشین مقدماتی ۲</h3>|
| -: | :- |
|عنوان درس به انگلیسی:|Elementary Machine Learning II|نوع درس و واحد|
|دروس پیش‏نیاز:||پایه £|نظری ¢|
|دروس هم‏نیاز:||تخصصی الزامی£|عملی £|
|تعداد واحد:|3|حل تمرین دارد|تخصصی اختیاری ¢|نظری-عملی £|
|تعداد ساعت:|48||رساله / پایان‏نامه £||
...
|عنوان درس به فارسی:|<h3><a name="_نظریه_مقدماتی_کد"></a>نظریه مقدماتی کد گذاری </h3>|
| -: | :- |
...
|عنوان درس به فارسی:|<h3>` `نظریه بازی </h3>|
| -: | :- |
|عنوان درس به انگلیسی:|Game Theory|نوع درس و واحد|
...
|نوع آموزش تکمیلی عملی (در صورت نیاز): سفر علمی £ آزمایشگاه نرم افزار £ سمینار £ کارگاه ¢موارد دیگر: ..............|
||
هدف کلی:   آشنایی با مبانی پایه‌ای نظریه بازی‌ها و استفاده از آن در مدل سازی مسائل کاربردی.

اهداف ویژه: توانایی به کارگیری مبانی پایه ای و مدل سازی نظریه بازی ها در حل مسائل کاربردی.
...
|عنوان درس به فارسی:|<h3><a name="_رگرسیون1"></a>رگرسیون1 </h3>|
| -: | :- |
...
|عنوان درس به فارسی:|<h3><a name="_سری_های_زمانی"></a>سری های زمانی  </h3>|
| -: | :- |
...
|دروس پیش‏نیاز:|ساختمان داده و الگوریتم‌ها، آمار و احتمال 1 |**پایه £**|نظری  £|
|دروس هم‏نیاز:|ندارد|تخصصی الزامی**  £|عملی £|
...
|دروس پیش‏نیاز:|یادگیری آماری مقدماتی|پایه £|نظری **n**|
|دروس هم‏نیاز:||تخصصی الزامی £|عملی £|
|تعداد واحد:|3|حل تمرین دارد|تخصصی اختیاری **n**|نظری-عملی £|
|تعداد ساعت:|48||رساله / پایان‏نامه £||
|نوع آموزش تکمیلی عملی (در صورت نیاز): سفر علمی £ آزمایشگاه نرم افزار ¢ سمینار £ کارگاه £ موارد دیگر: ..............|
...
اهداف ویژه:  توانمندی و مهارت درپیاده سازی الگوریتم‌های یادگیری عمیق برای تحلیل داده ها از طریق زبان Python
...
|عنوان درس به فارسی:|<h3><a name="_توسعه_کسب_و"></a>توسعه کسب و کارهای نوپا</h3>|
| -: | :- |
...
|عنوان درس به فارسی:|<h3><a name="_مدیریت_و_کنترل"></a>مدیریت و کنترل پروژه </h3>|
| -: | :- |
...
|دروس پیش‏نیاز:|ندارد|**پایه £**|نظریn|
|دروس هم‏نیاز:|ریاضی عمومی 1|تخصصی الزامی£|عملی £|
...
|دروس پیش‏نیاز:|ندارد|**پایه £**|نظری£|
|دروس هم‏نیاز:|ریاضی عمومی 1|تخصصی الزامی£|عملی n|
...
|عنوان درس به فارسی:|<h3><a name="_شبکه‌های_اجتماعی"></a>شبکه‌های اجتماعی </h3>|
| -: | :- |
...
|عنوان درس به فارسی:|<h3><a name="_مباحثی_در_علوم"></a>مباحثی در علوم کامپیوتر </h3>|
| -: | :- |
...
|دروس هم‏نیاز:|ریاضی عمومی 2|تخصصی الزامی  **£**|عملی £|
|تعداد واحد:|3|حل تمرین ندارد|تخصصی اختیاری¢|نظری-عملی £|
|تعداد ساعت:|48||رساله / پایان‏نامه £||
|نوع آموزش تکمیلی عملی (در صورت نیاز): سفر علمی £ آزمایشگاه نرم افزار£ سمینار £ کارگاه ¢موارد دیگر: ..............|
||
...
|عنوان درس به فارسی:|<h3><a name="_آشنایی_با_تحلیل"></a>آشنایی با تحلیل کلان داده‌ها</h3>|
| -: | :- |
|عنوان درس به انگلیسی:|Introduction to Big Data Analysis|نوع درس و واحد|
|دروس پیش‏نیاز:|یادگیری آماری مقدماتی|پایه £|نظری £|
|دروس هم‏نیاز:||تخصصی الزامی £|عملی £|
|تعداد واحد:|2+1||تخصصی اختیاری ¢|نظری-عملی ¢|
|تعداد ساعت:|32+32||رساله / پایان‏نامه £||
...
اهداف ویژه:  تموانمندی و مهارت در  کار با داده های در مقیاس بزرگ و تحلیل آنها  با استفاده از نرم  افزار
...
|نوع آموزش تکمیلی عملی (در صورت نیاز): سفر علمی £ آزمایشگاه نرم افزار £ سمینار £ کارگاه ¢موارد دیگر: ..............|
||
هدف کلی:  **این درس سعی دارد تا پایه‌های تئوری و عملی آماری لازم برای تحلیل داده‌ها و یادگیری ماشین را فراهم نماید. برای بخش عملی، زبان پایتون توصیه می‌شود.**
