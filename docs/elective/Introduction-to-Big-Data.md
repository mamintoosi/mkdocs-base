...
| کارشناسی      | مقطع:       | آشنایی با کلان داده‌ها                      | نام درس:    |
| ------------- | ----------- | ------------------------------------------- | ----------- |
| تخصصی اختیاری | گروه درس:   | [پایگاه داده‌ها](../mandatory/Databases.md) | پیش‌نیاز:   |
...
\1. مار، برنارد (1396). [داده‌های بزرگ ارتقای تصمیم گیری و عملکرد با استفاده از داده‌های بزرگ هوشمند: تحلیل شناسی و معیارها]( )، ترجمه: موسی خانی، مرتضی، انتشارات آوند دانش. 
