...
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------ |
| پیش‌نیاز:   | [معادلات دیفرانسیل](../docs/curriculum/base/Differential-Equations.md) ،[تحقیق در عملیات](../docs/curriculum/mandatory/Operations-research.md) ،[آمار و احتمال ۱](../docs/curriculum/base/Probability-and-Statistics-I.md) | گروه درس:   | تخصصی الزامی |
