...
| ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------ |
| پیش‌نیاز:   | [مبانی محاسبات علمی](../docs/curriculum/mandatory/Elementary-Scientific-Computing.md) ،[ساختمان داده‌ها](../docs/curriculum/mandatory/Data-Structures.md) | گروه درس:   | تخصصی الزامی |
