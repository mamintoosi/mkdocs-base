...
| ------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------ | ----------- |
| تخصصی اختیاری | گروه درس:   | [شبکه‌های کامپیوتری](../docs/curriculum/elective/Computer-Networks.md) ،[سیستم‌های عامل](../docs/curriculum/elective/Operating-Systems.md) | پیش‌نیاز:   |
